...
public class deletedeptExamDAO {
	public void DeleteInfo(deptexam examObj)
	{
		  try 
		    {
		    	PreparedStatement
		        dbStatement = 
		        DBHanlde.prepareStatement("Delete from deptexam where studentexamID=?");
