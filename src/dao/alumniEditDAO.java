...
import model.alumni;
public class alumniEditDAO {
	public void EditInfo(alumni courseObj)
	{
		  try 
		    {
		    	PreparedStatement
		        ...
		        DBHanlde.prepareStatement(
		        		"Update alumni set alumniname=?,alumnidetail=? where alumniID=?");
		    	
		    	dbStatement.setString(1,courseObj.getAlumniname()); 
			        dbStatement.setString(2,courseObj.getAlumnidetail()); 
		        dbStatement.setString(3,courseObj.getAlumniID()); 
		       // dbStatement.setString(2,courseObj.getCoursename()); 
		       
		        
		
		      System.out.println("id:"+courseObj.getAlumniID());
		      System.out.println("name:"+courseObj.getAlumniname());
		      System.out.println("det:"+courseObj.getAlumnidetail());
		...
		public alumni GetUserInfo(String alumniID)
		{
		    ...
		    try 
		    {
		        ...
		        if (Resultset.next())
		        {
		        	...
		        	courseObj.setAlumnidetail(Resultset.getString("alumniedetail"));
